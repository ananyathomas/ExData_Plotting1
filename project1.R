data <- read.csv("/Users/ananyathomas/Downloads/household_power_consumption.txt", sep=";", na.strings="?",stringsAsFactors = FALSE)
df<- data.frame(subset(data, data$Date=="1/2/2007"|data$Date=="2/2/2007"))
